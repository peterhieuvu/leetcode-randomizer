...
const columns: ColumnsType<NeetcodeProblem> = [
    ...
    },
    {
        ...
        render: link => <Tag color='rgb(69, 69, 69)'>
    ...
    },
    {
        ...
        dataIndex: '',
        render: (_, record) => (<>
            {record.python && <Tag color='green'>
                <a href={record.python}>Python</a>
            </Tag>}
            {record.java && <Tag color='yellow'>
                <a href={record.java}>Java</a>
            </Tag>}
            {record.javascript && <Tag color='red'>
                <a href={record.javascript}>Javascript</a>
            </Tag>}
            {record.cpp && <Tag color='orange'>
